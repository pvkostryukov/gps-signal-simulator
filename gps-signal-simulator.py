...
class GPSSimulator:
    ...
    def set_speed(self, speed):
        ...
        Args:
            speed (float): Скорость в км/ч (диапазон: 0-30)
        ...
        try:
            ...
            if 0 <= speed <= 30:
                ...
                print(f"Ошибка: скорость должна быть от 0 до 30 км/ч (получено: {speed})")
                return False
...
def main():
    ...
    print("  speed <0-30>      - установить скорость (км/ч)")
        ...
        while True:
            ...
            if cmd == "quit":
                ...
                try:
                    ...
                    print("Формат: speed <число от 0 до 30>")
